...
def start_server():
    ...
    try:
        db_url = "cockroachdb:" + ":".join(os.environ['DATABASE_URL'].split(":")[1:]) + "&sslrootcert=cockroachlabs-cluster.crt"
        #db_url = os.environ['DATABASE_URL'] + "&sslrootcert=Servidor/cockroachlabs-cluster.crt"
